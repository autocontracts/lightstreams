...
The Lightstreams network will be capable of music and video streaming via the IPFS protocol layer, which is a proven peer-to-peer file distribution technology for serving content in format.
...
1. For a standard sale, an approximate 48% fee is charged; this comprises a 30% platform fee plus and an electronic delivery fee of $2.58. [[9]](http://andrewhy.de/amazons-markup-of-digital-delivery-to-indie-authors-is-129000/)
